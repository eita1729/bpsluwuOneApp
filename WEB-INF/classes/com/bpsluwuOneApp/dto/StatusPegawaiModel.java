...
import org.json.*;
public class StatusPegawaiModel {
    private int id = 0;
    ...
    public static class Collection{
		private ArrayList<StatusPegawaiModel> collection = new ArrayList<StatusPegawaiModel>();
		public ArrayList<StatusPegawaiModel> getCollection() {
